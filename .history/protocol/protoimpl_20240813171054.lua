...
---@alias ServerPackets.SetBlock fun(_, x: number, y: number, z: number, block: BlockIDs, connection: Connection?) @Updates client(s) of a block update
---@alias ServerPackets.SpawnPlayer fun(id: number, name: string, x: number, y: number, z: number, yaw: number, pitch: number, criteria?: fun(connection: Connection):boolean, connection: Connection?) @Tells clients to spawn player with specified positional information
---@alias ServerPackets.SetPositionAndOrientation fun(id: number, x: number, y: number, z: number, yaw: number, pitch: number, criteria?: fun(connection: Connection):boolean, skipSelf: boolean?, connection: Connection?) @Tells clients to move player to specified location
---@alias ServerPackets.PositionAndOrientationUpdate fun(id: number, x: number, y: number, z: number, yaw: number, pitch: number, criteria?: fun(connection: Connection):boolean, connection: Connection?) @Tells clients to move player relative to current (client-side) location and orientation
---@alias ServerPackets.PositionUpdate fun(id: number, x: number, y: number, z: number, criteria?: fun(connection: Connection):boolean, connection: Connection?) @Tells clients to move player relative to current (client-side) location
---@alias ServerPackets.OrientationUpdate fun(id: number, yaw: number, pitch: number, criteria?: fun(connection: Connection):boolean, connection: Connection?) @Tells client to rotate player relative to current (client-side) orientation
---@alias ServerPackets.DespawnPlayer fun(id: number, connection?: Connection?): boolean?, string? @Despawns a player from the world
---@alias ServerPackets.Message fun(message: string, criteria?: fun(connection: Connection):boolean, connection: Connection?): boolean?, string? @Sends a message to client(s)
