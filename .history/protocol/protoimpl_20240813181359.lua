...
---@alias ServerPackets.SetBlock fun(connection: Connection, _: any, x: number, y: number, z: number, block: BlockIDs) @Updates client(s) of a block update
---@alias ServerPackets.SpawnPlayer fun(connection: Connection, id: number, name: string, x: number, y: number, z: number, yaw: number, pitch: number) @Tells clients to spawn player with specified positional information
---@alias ServerPackets.SetPositionAndOrientation fun(connection: Connection, id: number, x: number, y: number, z: number, yaw: number, pitch: number, skipSelf: boolean?) @Tells clients to move player to specified location
---@alias ServerPackets.PositionAndOrientationUpdate fun(id: number, x: number, y: number, z: number, yaw: number, pitch: number, connection: Connection) @Tells clients to move player relative to current (client-side) location and orientation
---@alias ServerPackets.PositionUpdate fun(id: number, x: number, y: number, z: number, criteria?: fun(connection: Connection):boolean) @Tells clients to move player relative to current (client-side) location
---@alias ServerPackets.OrientationUpdate fun(connection: Connection, id: number, yaw: number, pitch: number, criteria?: fun(connection: Connection):boolean) @Tells client to rotate player relative to current (client-side) orientation
