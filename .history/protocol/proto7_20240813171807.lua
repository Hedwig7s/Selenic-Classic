...
---@param pitch number
---@param connection Connection
local function setPositionAndOrientation(connection, id, x, y, z, yaw, pitch)
    asserts.assertCoordinates(x,y,z,yaw,pitch)
    local function getData(id2, x, y, z, yaw, pitch)
        return string.pack(">BbhhhBB", 0x08, id2, x, y, z, yaw, pitch)
    end

    baseMovementPacket(connection, id, x, y, z, yaw, pitch, "SetPositionAndOrientation", getData)
end
