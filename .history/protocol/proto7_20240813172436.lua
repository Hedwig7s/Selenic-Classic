...
---@param pitch number
---@param connection Connection
local function positionAndOrientationUpdate(id, x, y, z, yaw, pitch, connection)
    ...
    baseMovementPacket(connection, id, x, y, z, yaw, pitch, getData, true)
end
...
local function orientationUpdate(id, yaw, pitch, criteria, connection)
    ...
    baseMovementPacket(connection, id, nil, nil, nil, yaw, pitch, getData, true)
end
...
---@param connection Connection
---@return boolean?, string?
local function serverMessage(connection,message, id)
    asserts.assertId(id)
    ...
    for _,msg in pairs(messages) do
        local packet = string.pack(">Bbc64",0x0D, id or -2,msg)
