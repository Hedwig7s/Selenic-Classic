...
function Player:LoadWorld(world)
    ...
    packets.ServerPackets.Message(nil,self.id,criterias.matchWorld,self.name.." joined this world")
end
...
function Player:Despawn(player)
    ...
    packets.ServerPackets.Message(nil,self.id,criterias.matchWorld,self.name.." left this world")
