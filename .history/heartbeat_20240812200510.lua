...
function heartbeat()
    ...
    print(config:getValue("server.name"))
    print(config:getValue("server.port"))
    print(#playerModule:GetPlayers())
    print(config:getValue("server.maxPlayers"))
    print(config:getValue("server.public"))
    print(server.info.Salt)
    print(server.info.Software.." "..server.info.Version)
    url = url 
