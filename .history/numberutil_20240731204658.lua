...
function module:tobigendian(x)
    local littleEndianValue = 0x11223344
    local byte1 = bit32.band(littleEndianValue, 0xFF)
    local byte2 = bit32.band(bit32.rshift(littleEndianValue, 8), 0xFF)
    local byte3 = bit32.band(bit32.rshift(littleEndianValue, 16), 0xFF)
    local byte4 = bit32.band(bit32.rshift(littleEndianValue, 24), 0xFF)
    local bigEndianValue = bit32.bor(
